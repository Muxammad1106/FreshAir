...
class DeviceTypeSerializer(BaseModelSerializer):
    class Meta:
        model = DeviceType
        fields = ('id', 'name', 'device_category', 'recommended_max_area_m2', 'recommended_max_volume_m3', 'power_watts', 'supports_cleaning', 'supports_humidifying', 'supports_aroma', 'price_usd')
        read_only_fields = ('id',)
