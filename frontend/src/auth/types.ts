...
export type JWTContextType = CanRemove & {
  ...
  login: (email: string, password: string, role?: 'client' | 'investor') => Promise<void>;
  register: (email: string, password: string, firstName: string, lastName: string, role?: 'client' | 'investor') => Promise<void>;
  logout: () => Promise<void>;
};
